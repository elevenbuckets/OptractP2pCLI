...
class OptractMedia extends KnifeIron {
	constructor(cfgObj)
		...
		// 	data: {
		// 		topic: Optract,
		// 		msg: {PENDING, TOTALTXS, POOLHASH, TIMESTAMP, SNAPSHOT},
		// 		public: <pubkey>
		// 	},
		// }
		this.parsePPID = (msgObj) => {}
		...
		this.makeMerkleTreeAndUploadRoot = () =>
                {
                        ...
                        stage = stage.then((rc) => {
                                ...
                                return this.sendTk(this.appName)('BlockRegistry')('submitMerkleRoot')(blkObj.initHeight, merkleRoot, rc[0].hash)();
                        })
		...
		this.validateMerkleProof = (targetLeaf, ipfsHash) =>
                {
                        return this.loadPreviousLeaves(ipfsHash).then((leaves) => {
                                ...
                                return this.call(this.appName)('BlockRegistry')('merkleTreeValidator')(proof, isLeft, targetLeaf, merkleRoot).then((rc) => {
                                        if (rc) {
		...
		// Since it is app-specific subclass, init dapp itself ...
