	 ...
	 .then(() => {
	     if(!appCfg.daemon) {
			...
			const expose = 
			{
				...
				stat: ['reports', 'getPrevBlockData', 'validPass', 'allAccounts', 'getBlockNo', 'makeMerkleTreeAndUploadRoot', 'buyMembership' ,'dbsync'],
				func: ['getBlockData', 'newAccount', 'memberStatus', 'ping', 'queueReceipts', 'getOproundLottery', 'parseMsgRLPx', 'get', 'isValidator'],
