	...
	constructor(cfgObj) {
		...
		this.getRssArticles = () =>
		{
			const categoryKeywords = {
				...
				'tech': [
				    'technology', '/tech', 'hacker', 'slashdot', 'renewable'
				],
				'emergingTech': [
				...
				'science': [
				    'astronomy', 'biology', 'physics', 'mathemati'
				],
				'blockchain': [
                                    'blockchain', 'ethereum', 'bitcoin', 'btc', 'defi', 'dapp',
                                    'cryoto currency', 'libra'
				],
				'finance': [
				    'finance', 'economics', 'economy', 'business', 'jpmorgan',
				    'trade-war', 'trade war'
                                ],
                                'investment': [
                                    'investment'
