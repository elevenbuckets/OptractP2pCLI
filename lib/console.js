	...
	constructor(cfgObj) {
		...
		this.getRssArticles = () =>
		{
			const categoryKeywords = {
				...
				'tech': ['technology', 'hacker', 'onezero', 'slashdot'],
				'finance': ['finance', 'economics', 'business', 'bond', 'nikkei', 'wealth', 'jpmorgan', 'dollar', 'euro'],
				'blockchain': ['blockchain', 'ethereum', 'bitcoin', 'btc', 'defi', 'dapp', 'crypto', 'decentral', 'libra']
			}
